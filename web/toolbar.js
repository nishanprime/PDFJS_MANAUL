 ...
 * @property {HTMLButtonElement} customsave - Button to print the document.
 * 
 */
...
class Toolbar {
  ...
  constructor(options, eventBus) {
    ...
    const buttons = [
      ...
      // TODO: customsave, need to have the element on options
      {
        element: options.saveDocument,
        eventName: "customsave",
      },
      {
  ...
  #bindListeners(buttons) {
    ...
    for (const { element, eventName, eventDetails } of buttons) {
      console.log(element, eventName, eventDetails);
